...
export function useAppointmentDistributionTrendData() {
  ...
  const fetchGrossExpenseData = async () => {
    ...
    const response =
      await dashboardService.GetAppointmentDistributionReasonTrend(payload);
...
export type UseInventoryTrendReturn = ReturnType<
  typeof useAppointmentDistributionTrendData
>;
